...
func tplCurdTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "tpl/curd.tpl", size: 6163, mode: os.FileMode(420), modTime: time.Unix(1565753221, 0)}
